...
<script type="text/javascript">
    function deleteConfirm(id) {
        if (confirm('¿Esta realmente segur@ de Eliminar?')) {
            window.location.href = "material/delete" + "/" + id;
                                    ...
                                    <ul class="icons-list">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a href="<?php echo base_url('material/edit')."/".$row->idTipoMaterial; ?>"><i class="icon-file-pdf" ></i> Modificar</a></li>
                                                <li><a href="#" onclick="deleteConfirm(<?php echo $row->idTipoMaterial; ?>)"><i class="icon-file-excel"></i> Eliminar</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </td>
                ...
                <div class="panel panel-flat">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" action="" name="FormDatos" id="FormDatos" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group has-feedback has-feedback-left">
                                                    <input type="text" class="form-control input-xlg" placeholder="Ingresa el nuevo material" id="material" name="material">
                            ...
                            <a class="btn btn-primary" id="btnCancelarE" href="<?php echo base_url();?>material" type="submit" name="action"><i class="fa fa-arrow-circle-left"></i> Cancelar
                                                </a>
