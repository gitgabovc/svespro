...
<script type="text/javascript">
    function deleteConfirm(id) {
        if (confirm('¿Esta realmente segur@ de Eliminar?')) {
            window.location.href = "color/delete" + "/" + id;
                ...
                <div class="panel panel-flat">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" action="" name="FormDatos" id="FormDatos" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group has-feedback has-feedback-left">
                                                    <input type="text" class="form-control input-xlg" placeholder="Ingresa el nuevo color" id="color" name="color">
                            ...
                            <a class="btn btn-primary" id="btnCancelarE" href="<?php echo base_url();?>color" type="submit" name="action"><i class="fa fa-arrow-circle-left"></i> Cancelar
                                                </a>
