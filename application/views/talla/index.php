                                    ...
                                    <ul class="icons-list">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a href="<?php echo base_url('talla/edit')."/".$row->idTalla; ?>"><i class="icon-pencil5" ></i> Modificar</a></li>
                                                <li><a href="#" onclick="deleteConfirm(<?php echo $row->idTalla; ?>)"><i class="icon-bin"></i> Eliminar</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </td>
