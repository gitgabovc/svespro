...
<script type="text/javascript">
    function deleteConfirm(id) {
        if (confirm('¿Esta realmente segur@ de Eliminar?')) {
            window.location.href = "talla/delete" + "/" + id;
                                    ...
                                    <ul class="icons-list">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a href="<?php echo base_url('talla/edit')."/".$row->idTalla; ?>"><i class="icon-file-pdf" ></i> Modificar</a></li>
                                                <li><a href="#" onclick="deleteConfirm(<?php echo $row->idTalla; ?>)"><i class="icon-file-excel"></i> Eliminar</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </td>
                ...
                <div class="panel panel-flat">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" action="" name="FormDatos" id="FormDatos" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group has-feedback has-feedback-left">
                                                    <input type="text" class="form-control input-xlg" placeholder="Ingresa la nueva talla" id="talla" name="talla">
                            ...
                            <a class="btn btn-primary" id="btnCancelarE" href="<?php echo base_url();?>talla" type="submit" name="action"><i class="fa fa-arrow-circle-left"></i> Cancelar
                                                </a>
