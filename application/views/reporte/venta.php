        ...
        <div class="panel-body">
            ...
            <div class="form-horizontal" >
                ...
                <fieldset class="content-group">
                    ...
                    <div class="form-group">
                        <div class="col-lg-10">
                            ...
                            <h3>Reporte Ventas Por Fechas</h3>
                ...
                <div class="text-left" style="margin-top:10px;">
                    <button class="btn btn-success" id="btnSinFechas" name="btnGuardar">Mostrar Todas Las Ventas <i class="icon-arrow-right14 position-right"></i></button>
                </div>
