                                    ...
                                    <ul class="icons-list">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a href="<?php echo base_url('categoria/edit')."/".$row->idCategoria; ?>"><i class="icon-pencil5" ></i> Modificar</a></li>
                                                <li><a href="#" onclick="deleteConfirm(<?php echo $row->idCategoria; ?>)"><i class="icon-bin"></i> Eliminar</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </td>
                ...
                <div class="panel panel-flat">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" action="" name="FormDatos" id="FormDatos" method="POST">
                            ...
                            <a class="btn btn-primary" id="btnCancelarE" href="<?php echo base_url();?>categoria" type="submit" name="action"><i class="fa fa-arrow-circle-left"></i> Cancelar
                                                </a>
